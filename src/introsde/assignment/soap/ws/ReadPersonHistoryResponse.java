 ...
 *       &lt;sequence>
 *         &lt;element name="measurement" type="{http://ws.soap.assignment.introsde/}measurementHistory" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadPersonHistoryResponse {
    ...
    protected List<MeasurementHistory> measurement;
     ...
     * 
     */
    public List<MeasurementHistory> getMeasurement() {
        if (measurement == null) {
            measurement = new ArrayList<MeasurementHistory>();
        }
